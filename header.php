 ...
 * Header Template
 *
 * Edited for Travelsommelier Child Theme
 * @file           header.php
 * @package        Responsive
 * @author         Emil Uzelac
...
<html class="no-js" <?php language_attributes(); ?>> <!--<![endif]-->
	<head>
		...
		<script async src="https://www.googletagmanager.com/gtag/js?id=UA-122877593-1"></script>
		<script>
		  window.dataLayer = window.dataLayer || [];
		  function gtag(){dataLayer.push(arguments);}
		  gtag('js', new Date());

		  gtag('config', 'UA-122877593-1');
		</script>
		...
		<div id="content-outer">
			<div id="logo">
					<a href="<?php echo esc_url(home_url( '/' )); ?>">
						<div class="ts-logo-content">
							<h2>Travel Sommelier</h2>
							<h6>Curated Luxury Travel</h6>
						</div>
						<div class="ts-logo-img">
							<img src="<?php header_image(); ?>" width="<?php echo get_custom_header()->width; ?>" height="<?php echo get_custom_header()->height; ?>" alt="<?php esc_attr(bloginfo( 'name' )); ?>"/>
						</div>
					</a>
			</div><!-- end of #logo -->
		</div>
